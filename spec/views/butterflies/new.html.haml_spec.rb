...
describe "butterflies/new" do
  before(:each) do
    assign(:butterfly, stub_model(Butterfly,
      :title => "MyString",
      :description => "MyText",
      :author_id => 1,
  ...
  it "renders new butterfly form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => butterflies_path, :method => "post" do
